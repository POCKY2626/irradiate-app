...
              {/* ▼ 修正点1: gridからflex wrapに変更し、中央揃えにしました */}
              <div className="flex flex-wrap justify-center gap-6">
                {councilMembers.map(member => (
                  <div key={member.name} className="bg-gray-800/30 backdrop-blur-md border border-gray-700 p-5 rounded-xl text-center flex flex-col items-center justify-center hover:bg-gray-700/50 transition duration-300 w-36">
